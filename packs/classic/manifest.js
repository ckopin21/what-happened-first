...
window.CLASSIC_PACK_MANIFEST={
  ...
  packs:[
    {id:"general-knowledge-v3",name:"General Knowledge",genre:"General Knowledge",file:"current.js"},
    {id:"general-knowledge-v4",name:"General Knowledge II",genre:"General Knowledge",file:"general-knowledge-v4.js"}
  ]
};
